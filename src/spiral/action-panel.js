...
class ActionPanel extends Panel {
    ...
    constructor(x, y, map, polygon, w=200, h=155) {
        ...
        // control k
        this.diagonalBox = new Button(this.x+25, this.y+35, 100, 20, [["Diagonal: " + this.map.k, color.BLACK]]);
        this.buttons.push(this.diagonalBox);
        this.decDiagonal = new TriangleButton(this.x+135, this.diagonalBox.y+5, 10, 10, "left");
    ...
    buttonMouseAction() {
        ...
        if (this.showPanel) {
            // diagonal control
            if (this.decDiagonal.isHovering() && this.map.k-1 > this.map.l) {
                this.map.k--;
                this.diagonalBox.text = [["Diagonal: " + this.map.k, color.BLACK]];
