...
class CtrlPanel extends Panel {
     ...
     */
    constructor(x, y, polygon, mapPolygons, w=200, h=370) {
        ...
        this.x4Box = new Button(this.x+25, this.y+220, 100, 20, [["x4: " + MathHelper.round(this.polygon.cornerCoords[4], 5), color.BLACK]]);
        this.buttons.push(this.x4Box);
        this.decX4 = new TriangleButton(this.x+135, this.y+225, 10, 10, "left");
        this.buttons.push(this.decX4);
        this.incX4 = new TriangleButton(this.x+155, this.y+225, 10, 10, "right");
        this.buttons.push(this.incX4);
        this.x5Box = new Button(this.x+25, this.y+250, 100, 20, [["x5: " + MathHelper.round(this.polygon.cornerCoords[5], 5), color.BLACK]]);
        this.buttons.push(this.x5Box);
        this.decX5 = new TriangleButton(this.x+135, this.y+255, 10, 10, "left");
        this.buttons.push(this.decX5);
        this.incX5 = new TriangleButton(this.x+155, this.y+255, 10, 10, "right");
        this.buttons.push(this.incX5);

        this.rateBox = new Button(this.x+25, this.y+280, 100, 20, [["Rate: " + this.rate, color.BLACK]]);
        this.buttons.push(this.rateBox);
        this.decRate = new TriangleButton(this.x+135, this.y+285, 10, 10, "left");
        this.buttons.push(this.decRate);
        this.incRate = new TriangleButton(this.x+155, this.y+285, 10, 10, "right");
    ...
    updateButtonPositions() {
        ...
        this.x4Box.y = this.y+220;
        this.decX4.y = this.y+225;
        this.incX4.y = this.y+225;
        this.x5Box.y = this.y+250;
        this.decX5.y = this.y+255;
        this.incX5.y = this.y+255;

        this.rateBox.y = this.y+280;
        this.decRate.y = this.y+285;
        this.incRate.y = this.y+285;
